...
public class OrderAdd extends JPanelBase {
	...
	private void fillInOrderData(Order order) {
		...
		cbOrderStatus.setSelectedItem(order.getStatus().getStatusName());
		txtBoxNo.setText(order.getBoxNumber().toString());
		txtOrderValue.setText(ConvertTypeUtil.toString(order.getOrderValue()));
		txtPaymentOnAccount.setText(ConvertTypeUtil.toString(order.getPaymentOnAccount()));
		txtPaymentLeft.setText(ConvertTypeUtil.toString(order.getPaymentLeft()));
		...
		txtFramePrice.setText(order.getFramePrice().toString());
		txtFrameDiscount.setText(order.getFrameDiscount().toString());
		txtFrameValue.setText(order.getFrameSellPrice().toString());
		...
		txtRightLensDiscount.setText(ConvertTypeUtil.toString(order.getLensDiscountER()));
		txtRightLensPower.setText(order.getLensPowerER());
		txtRightLensPrice.setText(ConvertTypeUtil.toString(order.getLensPriceER()));
		txtRightLensValue.setText(ConvertTypeUtil.toString(order.getLensSellPriceER()));
		...
		txtLeftLensDiscount.setText(ConvertTypeUtil.toString(order.getLensDiscountEL()));
		txtLeftLensPower.setText(order.getLensPowerEL());
		txtLeftLensPrice.setText(ConvertTypeUtil.toString(order.getLensPriceEL()));
		txtLeftLensValue.setText(ConvertTypeUtil.toString(order.getLensSellPriceEL()));
		...
		txtHeightR.setText(ConvertTypeUtil.toString(order.getHeightRight()));
		txtHeightL.setText(ConvertTypeUtil.toString(order.getHeightLeft()));
		...
		if (order.getExamination() != null) {
			...
			txtExaminationPrice.setText(ConvertTypeUtil.toString(order.getExaminationPrice()));
			txtExaminationValue.setText(ConvertTypeUtil.toString(order.getExaminationSellPrice()));
			txtExaminationDiscount.setText(ConvertTypeUtil.toString(order.getExaminationDiscount()));
		}
	...
	public long saveOrder() {
		...
		try {
			order.setStatus(Status.getStatusByName(cbOrderStatus.getSelectedItem().toString()));
			order.setBoxNumber(txtBoxNo.getText());
			order.setStartDate(daStartDate.getDate());
			order.setEndDate(daEndDate.getDate());
			order.setPaymentOnAccount(ConvertTypeUtil.getBigDecimalFromFieldValue(txtPaymentOnAccount));
			order.setOrderValue(ConvertTypeUtil.getBigDecimalFromFieldValue(txtOrderValue));
			order.setPaymentLeft(ConvertTypeUtil.getBigDecimalFromFieldValue(txtPaymentLeft));
			order.setFrame(frame);
			order.setFramePrice(ConvertTypeUtil.getBigDecimalFromFieldValue(txtFramePrice));
			order.setFrameDiscount(ConvertTypeUtil.getBigDecimalFromFieldValue(txtFrameDiscount));
			order.setFrameSellPrice(ConvertTypeUtil.getBigDecimalFromFieldValue(txtFrameValue));
			...
			order.setLensDiscountER(ConvertTypeUtil.getBigDecimalFromFieldValue(txtRightLensDiscount));
			order.setLensPriceER(ConvertTypeUtil.getBigDecimalFromFieldValue(txtRightLensPrice));
			order.setLensSellPriceER(ConvertTypeUtil.getBigDecimalFromFieldValue(txtRightLensValue));
			...
			order.setLensDiscountEL(ConvertTypeUtil.getBigDecimalFromFieldValue(txtLeftLensDiscount));
			order.setLensPriceEL(ConvertTypeUtil.getBigDecimalFromFieldValue(txtLeftLensPrice));
			order.setLensSellPriceEL(ConvertTypeUtil.getBigDecimalFromFieldValue(txtLeftLensValue));
			order.setColourLensEL(txtColourEL.getText());
			order.setNote(txtOrderNote.getText());
			order.setExaminationPrice(ConvertTypeUtil.getBigDecimalFromFieldValue(txtExaminationPrice));
			order.setExaminationDiscount(ConvertTypeUtil.getBigDecimalFromFieldValue(txtExaminationDiscount));
			order.setExaminationSellPrice(ConvertTypeUtil.getBigDecimalFromFieldValue(txtExaminationValue));
			if (!txtExaminationELAdd.getText().isEmpty() || !txtExaminationELVisus.getText().isEmpty()
					|| !txtExaminationELVisusAx.getText().isEmpty() || !txtExaminationELCorrection.getText().isEmpty()
					|| !txtExaminationERAdd.getText().isEmpty() || !txtExaminationERVisus.getText().isEmpty()
					|| !txtExaminationERVisusAx.getText().isEmpty() || !txtExaminationERCorrection.getText().isEmpty()
			...
			order.setPdRight(ConvertTypeUtil.getFloatFromFieldValue(txtPdR));
			order.setPdLeft(ConvertTypeUtil.getFloatFromFieldValue(txtPdL));
			order.setHeightRight(ConvertTypeUtil.getFloatFromFieldValue(txtHeightR));
			order.setHeightLeft(ConvertTypeUtil.getFloatFromFieldValue(txtHeightL));
	...
	public void refreshPositionValue(JTextField txtValueWoDiscount, JTextField txtDiscount,
			JTextField txtValueWtDiscount) {
		try {
			BigDecimal valueWoDiscount = ConvertTypeUtil.getBigDecimalFromFieldValue(txtValueWoDiscount);
			BigDecimal discountValue = ConvertTypeUtil.getBigDecimalFromFieldValue(txtDiscount);
			txtValueWtDiscount.setText((valueWoDiscount.subtract(discountValue)).toString());
		} catch (ConvertValueException e) {
			return;
		}
	}
	...
	/*
	 * private BigDecimal getBigDecimalValue(JTextField txtField) { BigDecimal
	 * res = new BigDecimal("0"); if (!txtField.getText().isEmpty()) { try { res
	 * = new BigDecimal(txtField.getText()); } catch (Exception e) { JOptionPane
	 * .showMessageDialog( null,
	 * "Proszę wprowadzić wartość liczbową w formacie: 123.45",
	 * "Błąd wartości liczbowej", JOptionPane.ERROR_MESSAGE); } } return res; }
	 */

	private void refreshOrderValue() {
		try {
			BigDecimal frameValue = ConvertTypeUtil.getBigDecimalFromFieldValue(txtFrameValue);
			BigDecimal leftLensValue = ConvertTypeUtil.getBigDecimalFromFieldValue(txtRightLensValue);
			BigDecimal rightLensValue = ConvertTypeUtil.getBigDecimalFromFieldValue(txtLeftLensValue);
			BigDecimal examinationValue = ConvertTypeUtil.getBigDecimalFromFieldValue(txtExaminationValue);
			txtOrderValue.setText((frameValue.add(leftLensValue).add(rightLensValue).add(examinationValue)).toString());
		} catch (ConvertValueException e) {
			return;
		}
	}
	...
	public void initGUI() {
		...
		panOrderData.setBorder(BorderFactory.createTitledBorder("Dane zamówienia"));

		JPanel panPaymentData = new JPanel();
		panPaymentData.setBorder(BorderFactory.createTitledBorder("Dane płatności"));
		...
		btnSave.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				long id = saveOrder();
				if (id > 0) {
					JOptionPane.showMessageDialog(null, "Zlecenie zostało zapisane pomyślnie.", "Zapis OK",
							JOptionPane.INFORMATION_MESSAGE);
				} else {
					JOptionPane.showMessageDialog(null, "Zapis nie powiódł się.", "Błąd zapisu",
		...
		groupLayout.setHorizontalGroup(groupLayout.createParallelGroup(Alignment.LEADING).addGroup(groupLayout
				...
				.addGroup(groupLayout.createParallelGroup(Alignment.LEADING)
						.addComponent(panOrder, Alignment.TRAILING, GroupLayout.DEFAULT_SIZE, 884, Short.MAX_VALUE)
						.addGroup(groupLayout.createSequentialGroup().addComponent(btnSave)
								.addPreferredGap(ComponentPlacement.RELATED).addComponent(btnPrint)
								.addPreferredGap(ComponentPlacement.RELATED).addComponent(btnCloseWindow))
						.addComponent(panPaymentData, Alignment.TRAILING, GroupLayout.DEFAULT_SIZE, 884,
								Short.MAX_VALUE)
						.addComponent(panOrderData, Alignment.TRAILING, GroupLayout.DEFAULT_SIZE, 884, Short.MAX_VALUE)
						.addComponent(panPersonData, GroupLayout.PREFERRED_SIZE, 884, Short.MAX_VALUE))
				.addContainerGap()));
		groupLayout.setVerticalGroup(groupLayout.createParallelGroup(Alignment.LEADING)
				.addGroup(groupLayout.createSequentialGroup().addGap(6)
						.addComponent(panPersonData, GroupLayout.PREFERRED_SIZE, 51, GroupLayout.PREFERRED_SIZE)
						.addPreferredGap(ComponentPlacement.RELATED)
						.addComponent(panOrderData, GroupLayout.PREFERRED_SIZE, 47, GroupLayout.PREFERRED_SIZE)
						.addPreferredGap(ComponentPlacement.RELATED)
						.addComponent(panPaymentData, GroupLayout.PREFERRED_SIZE, 51, GroupLayout.PREFERRED_SIZE)
						.addPreferredGap(ComponentPlacement.RELATED)
						.addComponent(panOrder, GroupLayout.PREFERRED_SIZE, 575, GroupLayout.PREFERRED_SIZE)
						.addPreferredGap(ComponentPlacement.RELATED, GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
						.addGroup(groupLayout.createParallelGroup(Alignment.BASELINE).addComponent(btnSave)
								.addComponent(btnPrint).addComponent(btnCloseWindow))
						.addContainerGap()));

		JTabbedPane tabbedPane = new JTabbedPane(JTabbedPane.TOP);
		GroupLayout gl_panOrder = new GroupLayout(panOrder);
		gl_panOrder.setHorizontalGroup(
				gl_panOrder.createParallelGroup(Alignment.LEADING).addGroup(gl_panOrder.createSequentialGroup()
						.addComponent(tabbedPane, GroupLayout.PREFERRED_SIZE, 696, Short.MAX_VALUE).addContainerGap()));
		gl_panOrder.setVerticalGroup(gl_panOrder.createParallelGroup(Alignment.LEADING)
				.addGroup(gl_panOrder.createSequentialGroup()
		...
		txtFramePrice.addFocusListener(new FocusAdapter() {
			...
			public void focusLost(FocusEvent e) {
				refreshPositionValue(txtFramePrice, txtFrameDiscount, txtFrameValue);
			}
		});
		...
		btnWybierz.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				if (selectedRow >= 0) {
					Frame selectedFrame = frameTableModel.getElementAt(selectedRow);
					frame = selectedFrame;
		...
		btnSzukaj.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				frameTableModel.setData(frameManager.getFrameByCriteria(txtFrameMark.getText(), txtFrameModel.getText(),
		...
		panRightLens.setBorder(BorderFactory.createTitledBorder("Prawa soczewka"));
		...
		txtRightLensPrice.addFocusListener(new FocusAdapter() {
			@Override
			public void focusLost(FocusEvent e) {
				refreshPositionValue(txtRightLensPrice, txtRightLensDiscount, txtRightLensValue);
			}
		});
		...
		txtRightLensValue.getDocument().addDocumentListener(new DocumentListener() {
		...
		panLeftLens.setBorder(BorderFactory.createTitledBorder("Lewa soczewka"));
		...
		txtLeftLensPrice.addFocusListener(new FocusAdapter() {
			@Override
			public void focusLost(FocusEvent e) {
				refreshPositionValue(txtLeftLensPrice, txtLeftLensDiscount, txtLeftLensValue);
			}
		});
		...
		txtLeftLensValue.getDocument().addDocumentListener(new DocumentListener() {
		...
		panOtherData.setBorder(BorderFactory.createTitledBorder("Pozostałe dane"));
		GroupLayout gl_panExamination = new GroupLayout(panExamination);
		gl_panExamination.setHorizontalGroup(gl_panExamination.createParallelGroup(Alignment.TRAILING)
				.addGroup(gl_panExamination.createSequentialGroup().addContainerGap().addGroup(gl_panExamination
						.createParallelGroup(Alignment.TRAILING)
						.addComponent(panOtherData, Alignment.LEADING, GroupLayout.DEFAULT_SIZE, 638, Short.MAX_VALUE)
						.addComponent(panNote, Alignment.LEADING, GroupLayout.DEFAULT_SIZE, 638, Short.MAX_VALUE)
						.addComponent(panCorrection, Alignment.LEADING, GroupLayout.DEFAULT_SIZE, 638, Short.MAX_VALUE))
						.addContainerGap()));
		gl_panExamination.setVerticalGroup(gl_panExamination.createParallelGroup(Alignment.LEADING)
				.addGroup(gl_panExamination.createSequentialGroup().addContainerGap()
						.addComponent(panCorrection, GroupLayout.PREFERRED_SIZE, 97, GroupLayout.PREFERRED_SIZE)
						.addPreferredGap(ComponentPlacement.RELATED)
						.addComponent(panNote, GroupLayout.PREFERRED_SIZE, 116, GroupLayout.PREFERRED_SIZE)
						.addPreferredGap(ComponentPlacement.RELATED)
						.addComponent(panOtherData, GroupLayout.PREFERRED_SIZE, 84, GroupLayout.PREFERRED_SIZE)
		...
		txtExaminationPrice.addFocusListener(new FocusAdapter() {
			@Override
			public void focusLost(FocusEvent e) {
				refreshPositionValue(txtExaminationPrice, txtExaminationDiscount, txtExaminationValue);
			}
		});
		...
		txtExaminationValue.getDocument().addDocumentListener(new DocumentListener() {
		...
		gl_panOtherData.setHorizontalGroup(gl_panOtherData.createParallelGroup(Alignment.LEADING)
				.addGroup(gl_panOtherData.createSequentialGroup().addContainerGap().addGroup(gl_panOtherData
						.createParallelGroup(Alignment.LEADING).addComponent(chckbxMyExamination)
						.addGroup(gl_panOtherData.createSequentialGroup().addComponent(lblCena)
								.addPreferredGap(ComponentPlacement.RELATED)
								.addComponent(txtExaminationPrice, GroupLayout.PREFERRED_SIZE, GroupLayout.DEFAULT_SIZE,
										GroupLayout.PREFERRED_SIZE)
								.addPreferredGap(ComponentPlacement.RELATED).addComponent(lblNewLabel_1)
								.addPreferredGap(ComponentPlacement.RELATED)
								.addComponent(txtExaminationDiscount, GroupLayout.PREFERRED_SIZE,
										GroupLayout.DEFAULT_SIZE, GroupLayout.PREFERRED_SIZE)
								.addPreferredGap(ComponentPlacement.RELATED).addComponent(lblWarto)
								.addPreferredGap(ComponentPlacement.RELATED).addComponent(txtExaminationValue,
										GroupLayout.PREFERRED_SIZE, GroupLayout.DEFAULT_SIZE,
										GroupLayout.PREFERRED_SIZE)))
						.addContainerGap(256, Short.MAX_VALUE)));
		gl_panOtherData.setVerticalGroup(gl_panOtherData.createParallelGroup(Alignment.LEADING).addGroup(gl_panOtherData
				.createSequentialGroup().addContainerGap().addComponent(chckbxMyExamination)
				.addPreferredGap(ComponentPlacement.UNRELATED)
				.addGroup(gl_panOtherData.createParallelGroup(Alignment.BASELINE).addComponent(lblCena)
						.addComponent(txtExaminationPrice, GroupLayout.PREFERRED_SIZE, GroupLayout.DEFAULT_SIZE,
								GroupLayout.PREFERRED_SIZE)
						.addComponent(lblNewLabel_1)
						.addComponent(txtExaminationDiscount, GroupLayout.PREFERRED_SIZE, GroupLayout.DEFAULT_SIZE,
								GroupLayout.PREFERRED_SIZE)
						.addComponent(lblWarto).addComponent(txtExaminationValue, GroupLayout.PREFERRED_SIZE,
								GroupLayout.DEFAULT_SIZE, GroupLayout.PREFERRED_SIZE))
		...
		gl_panNote.setHorizontalGroup(gl_panNote.createParallelGroup(Alignment.LEADING)
				.addGroup(gl_panNote.createSequentialGroup().addContainerGap()
						.addComponent(txtExaminationNote, GroupLayout.DEFAULT_SIZE, 602, Short.MAX_VALUE)
						.addContainerGap()));
		gl_panNote.setVerticalGroup(gl_panNote.createParallelGroup(Alignment.LEADING)
				.addGroup(gl_panNote.createSequentialGroup()
						.addComponent(txtExaminationNote, GroupLayout.DEFAULT_SIZE, 81, Short.MAX_VALUE)
						.addContainerGap()));
		...
		gl_panCorrection.setHorizontalGroup(gl_panCorrection.createParallelGroup(Alignment.LEADING)
				.addGroup(gl_panCorrection.createSequentialGroup().addContainerGap()
						.addGroup(gl_panCorrection.createParallelGroup(Alignment.LEADING)
								.addGroup(gl_panCorrection.createSequentialGroup().addComponent(lblOp).addGap(4)
										.addComponent(txtExaminationERCorrection, GroupLayout.PREFERRED_SIZE,
												GroupLayout.DEFAULT_SIZE, GroupLayout.PREFERRED_SIZE)
										.addGap(4).addComponent(lblCylinder_1).addGap(4)
										.addComponent(txtExaminationERVisus, GroupLayout.PREFERRED_SIZE,
												GroupLayout.DEFAULT_SIZE, GroupLayout.PREFERRED_SIZE)
										.addGap(4).addComponent(lblO_1).addGap(4)
										.addComponent(txtExaminationERVisusAx, GroupLayout.PREFERRED_SIZE,
												GroupLayout.DEFAULT_SIZE, GroupLayout.PREFERRED_SIZE)
										.addGap(18).addComponent(lblNewLabel).addGap(4)
										.addComponent(txtExaminationERAdd, GroupLayout.PREFERRED_SIZE,
												GroupLayout.DEFAULT_SIZE, GroupLayout.PREFERRED_SIZE))
								.addGroup(gl_panCorrection.createSequentialGroup().addComponent(lblOl).addGap(4)
										.addComponent(txtExaminationELCorrection, GroupLayout.PREFERRED_SIZE,
												GroupLayout.DEFAULT_SIZE, GroupLayout.PREFERRED_SIZE)
										.addGap(4).addComponent(lblCylinder).addGap(4)
										.addComponent(txtExaminationELVisus, GroupLayout.PREFERRED_SIZE,
												GroupLayout.DEFAULT_SIZE, GroupLayout.PREFERRED_SIZE)
										.addGap(4).addComponent(lblO).addGap(4)
										.addComponent(txtExaminationELVisusAx, GroupLayout.PREFERRED_SIZE,
												GroupLayout.DEFAULT_SIZE, GroupLayout.PREFERRED_SIZE)
										.addGap(18).addComponent(lblAdd).addGap(4).addComponent(txtExaminationELAdd,
												GroupLayout.PREFERRED_SIZE, GroupLayout.DEFAULT_SIZE,
												GroupLayout.PREFERRED_SIZE)))
						.addContainerGap(138, Short.MAX_VALUE)));
		gl_panCorrection.setVerticalGroup(gl_panCorrection.createParallelGroup(Alignment.LEADING)
				.addGroup(gl_panCorrection.createSequentialGroup().addContainerGap().addGroup(gl_panCorrection
						.createParallelGroup(Alignment.LEADING)
						.addGroup(gl_panCorrection.createSequentialGroup().addGap(3).addComponent(lblOp))
						.addComponent(txtExaminationERCorrection, GroupLayout.PREFERRED_SIZE, GroupLayout.DEFAULT_SIZE,
								GroupLayout.PREFERRED_SIZE)
						.addGroup(gl_panCorrection.createSequentialGroup().addGap(3).addComponent(lblCylinder_1))
						.addComponent(txtExaminationERVisus, GroupLayout.PREFERRED_SIZE, GroupLayout.DEFAULT_SIZE,
								GroupLayout.PREFERRED_SIZE)
						.addGroup(gl_panCorrection.createSequentialGroup().addGap(3).addComponent(lblO_1))
						.addComponent(txtExaminationERVisusAx, GroupLayout.PREFERRED_SIZE, GroupLayout.DEFAULT_SIZE,
								GroupLayout.PREFERRED_SIZE)
						.addGroup(gl_panCorrection.createSequentialGroup().addGap(3).addComponent(lblNewLabel))
						.addComponent(txtExaminationERAdd, GroupLayout.PREFERRED_SIZE, GroupLayout.DEFAULT_SIZE,
								GroupLayout.PREFERRED_SIZE))
						.addPreferredGap(ComponentPlacement.UNRELATED)
						.addGroup(gl_panCorrection.createParallelGroup(Alignment.LEADING)
								.addGroup(gl_panCorrection.createSequentialGroup().addGap(3).addComponent(lblOl))
								.addComponent(txtExaminationELCorrection, GroupLayout.PREFERRED_SIZE,
										GroupLayout.DEFAULT_SIZE, GroupLayout.PREFERRED_SIZE)
								.addGroup(gl_panCorrection.createSequentialGroup().addGap(3).addComponent(lblCylinder))
								.addComponent(txtExaminationELVisus, GroupLayout.PREFERRED_SIZE,
										GroupLayout.DEFAULT_SIZE, GroupLayout.PREFERRED_SIZE)
								.addGroup(gl_panCorrection.createSequentialGroup().addGap(3).addComponent(lblO))
								.addComponent(txtExaminationELVisusAx, GroupLayout.PREFERRED_SIZE,
										GroupLayout.DEFAULT_SIZE, GroupLayout.PREFERRED_SIZE)
								.addGroup(gl_panCorrection.createSequentialGroup().addGap(3).addComponent(lblAdd))
								.addComponent(txtExaminationELAdd, GroupLayout.PREFERRED_SIZE, GroupLayout.DEFAULT_SIZE,
										GroupLayout.PREFERRED_SIZE))
						.addContainerGap(GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)));
		...
		gl_panOrderNote.setHorizontalGroup(gl_panOrderNote.createParallelGroup(Alignment.LEADING)
				.addGroup(gl_panOrderNote.createSequentialGroup().addContainerGap()
						.addComponent(txtOrderNote, GroupLayout.DEFAULT_SIZE, 678, Short.MAX_VALUE).addContainerGap()));
		gl_panOrderNote.setVerticalGroup(gl_panOrderNote.createParallelGroup(Alignment.LEADING)
				.addGroup(gl_panOrderNote.createSequentialGroup().addContainerGap()
						.addComponent(txtOrderNote, GroupLayout.PREFERRED_SIZE, 319, GroupLayout.PREFERRED_SIZE)
		...
		txtPaymentOnAccount.addFocusListener(new FocusAdapter() {
			...
			public void focusLost(FocusEvent e) {
				try {
					txtPaymentLeft.setText((ConvertTypeUtil.getBigDecimalFromFieldValue(txtOrderValue)
							.subtract(ConvertTypeUtil.getBigDecimalFromFieldValue(txtPaymentOnAccount)).toString()));					
		...
		gl_panPaymentData.setHorizontalGroup(gl_panPaymentData.createParallelGroup(Alignment.LEADING)
				.addGroup(gl_panPaymentData.createSequentialGroup().addComponent(lblZaliczka)
						.addPreferredGap(ComponentPlacement.RELATED)
						.addComponent(txtOrderValue, GroupLayout.PREFERRED_SIZE, GroupLayout.DEFAULT_SIZE,
								GroupLayout.PREFERRED_SIZE)
						.addPreferredGap(ComponentPlacement.RELATED).addComponent(lblZaliczka_1)
						.addPreferredGap(ComponentPlacement.RELATED)
						.addComponent(txtPaymentOnAccount, GroupLayout.PREFERRED_SIZE, GroupLayout.DEFAULT_SIZE,
								GroupLayout.PREFERRED_SIZE)
						.addPreferredGap(ComponentPlacement.RELATED).addComponent(lblPozostaoDoZaplaty)
						.addPreferredGap(ComponentPlacement.RELATED).addComponent(txtPaymentLeft,
								GroupLayout.PREFERRED_SIZE, GroupLayout.DEFAULT_SIZE, GroupLayout.PREFERRED_SIZE)
						.addContainerGap(351, Short.MAX_VALUE)));
		gl_panPaymentData.setVerticalGroup(gl_panPaymentData.createParallelGroup(Alignment.LEADING)
				.addGroup(gl_panPaymentData.createSequentialGroup()
						.addGroup(gl_panPaymentData.createParallelGroup(Alignment.BASELINE).addComponent(lblZaliczka)
								.addComponent(txtOrderValue, GroupLayout.PREFERRED_SIZE, GroupLayout.DEFAULT_SIZE,
										GroupLayout.PREFERRED_SIZE)
								.addComponent(lblZaliczka_1)
								.addComponent(txtPaymentOnAccount, GroupLayout.PREFERRED_SIZE, GroupLayout.DEFAULT_SIZE,
										GroupLayout.PREFERRED_SIZE)
								.addComponent(lblPozostaoDoZaplaty).addComponent(txtPaymentLeft,
										GroupLayout.PREFERRED_SIZE, GroupLayout.DEFAULT_SIZE,
										GroupLayout.PREFERRED_SIZE))
		...
		cbOrderStatus = new JComboBox<String>();
		cbOrderStatus.setModel(new DefaultComboBoxModel<String>(Status.getNames()));
		...
		gl_panOrderData.setHorizontalGroup(gl_panOrderData.createParallelGroup(Alignment.LEADING)
				.addGroup(gl_panOrderData.createSequentialGroup().addComponent(lblStatusZamowienia)
						.addPreferredGap(ComponentPlacement.RELATED)
						.addComponent(cbOrderStatus, GroupLayout.PREFERRED_SIZE, GroupLayout.DEFAULT_SIZE,
								GroupLayout.PREFERRED_SIZE)
						.addPreferredGap(ComponentPlacement.RELATED).addComponent(lblNumerTacy)
						.addPreferredGap(ComponentPlacement.RELATED)
						.addComponent(txtBoxNo, GroupLayout.PREFERRED_SIZE, GroupLayout.DEFAULT_SIZE,
								GroupLayout.PREFERRED_SIZE)
						.addPreferredGap(ComponentPlacement.RELATED).addComponent(lblDataZlecenia)
						.addPreferredGap(ComponentPlacement.RELATED)
						.addComponent(daStartDate, GroupLayout.PREFERRED_SIZE, 99, GroupLayout.PREFERRED_SIZE)
						.addPreferredGap(ComponentPlacement.RELATED).addComponent(lblDataWydania)
						.addPreferredGap(ComponentPlacement.RELATED)
						.addComponent(daEndDate, GroupLayout.PREFERRED_SIZE, 103, GroupLayout.PREFERRED_SIZE)
						.addPreferredGap(ComponentPlacement.RELATED).addComponent(lblNumerZamwienia).addGap(4)
						.addComponent(txtOrderNumber, GroupLayout.PREFERRED_SIZE, GroupLayout.DEFAULT_SIZE,
								GroupLayout.PREFERRED_SIZE)
						.addContainerGap(GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)));
		gl_panOrderData.setVerticalGroup(gl_panOrderData.createParallelGroup(Alignment.LEADING)
				.addGroup(gl_panOrderData.createSequentialGroup()
						.addGroup(gl_panOrderData.createParallelGroup(Alignment.LEADING)
								.addGroup(gl_panOrderData
										.createParallelGroup(Alignment.BASELINE).addComponent(lblStatusZamowienia)
										.addComponent(cbOrderStatus, GroupLayout.PREFERRED_SIZE,
												GroupLayout.DEFAULT_SIZE, GroupLayout.PREFERRED_SIZE)
										.addComponent(lblNumerTacy)
										.addComponent(txtBoxNo, GroupLayout.PREFERRED_SIZE, GroupLayout.DEFAULT_SIZE,
												GroupLayout.PREFERRED_SIZE)
										.addComponent(lblDataZlecenia)
										.addComponent(daStartDate, GroupLayout.PREFERRED_SIZE, GroupLayout.DEFAULT_SIZE,
												GroupLayout.PREFERRED_SIZE)
										.addComponent(lblDataWydania).addComponent(daEndDate,
												GroupLayout.PREFERRED_SIZE, GroupLayout.DEFAULT_SIZE,
												GroupLayout.PREFERRED_SIZE))
								.addGroup(gl_panOrderData.createSequentialGroup().addGap(3)
		...
		gl_panPersonData.setHorizontalGroup(gl_panPersonData.createParallelGroup(Alignment.LEADING)
				.addGroup(gl_panPersonData.createSequentialGroup().addContainerGap().addComponent(label)
						.addPreferredGap(ComponentPlacement.RELATED)
						.addComponent(txtPersonName, GroupLayout.PREFERRED_SIZE, GroupLayout.DEFAULT_SIZE,
								GroupLayout.PREFERRED_SIZE)
						.addPreferredGap(ComponentPlacement.RELATED).addComponent(label_1)
						.addPreferredGap(ComponentPlacement.RELATED)
						.addComponent(txtPersonSurname, GroupLayout.PREFERRED_SIZE, GroupLayout.DEFAULT_SIZE,
								GroupLayout.PREFERRED_SIZE)
						.addPreferredGap(ComponentPlacement.RELATED).addComponent(label_2)
						.addPreferredGap(ComponentPlacement.RELATED)
						.addComponent(txtPersonPesel, GroupLayout.PREFERRED_SIZE, GroupLayout.DEFAULT_SIZE,
								GroupLayout.PREFERRED_SIZE)
						.addPreferredGap(ComponentPlacement.RELATED).addComponent(lblTelefon)
						.addPreferredGap(ComponentPlacement.RELATED).addComponent(txtPersonPhoneNo,
								GroupLayout.PREFERRED_SIZE, GroupLayout.DEFAULT_SIZE, GroupLayout.PREFERRED_SIZE)
						.addGap(361)));
		gl_panPersonData.setVerticalGroup(gl_panPersonData.createParallelGroup(Alignment.LEADING)
				.addGroup(gl_panPersonData.createSequentialGroup().addGap(5)
						.addGroup(gl_panPersonData.createParallelGroup(Alignment.BASELINE).addComponent(label)
								.addComponent(txtPersonName, GroupLayout.PREFERRED_SIZE, GroupLayout.DEFAULT_SIZE,
										GroupLayout.PREFERRED_SIZE)
								...
								.addComponent(txtPersonPesel, GroupLayout.PREFERRED_SIZE, GroupLayout.DEFAULT_SIZE,
										GroupLayout.PREFERRED_SIZE)
								.addComponent(lblTelefon).addComponent(txtPersonPhoneNo, GroupLayout.PREFERRED_SIZE,
										GroupLayout.DEFAULT_SIZE, GroupLayout.PREFERRED_SIZE))));
